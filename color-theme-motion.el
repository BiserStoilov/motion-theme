...
(defmacro color-theme-motion--with-colors (mode &rest body)
 "Execute `BODY' in a scope with variables bound to the various tomorrow colors.

Also sets background-mode to either 'light or 'terminal, for use in
setting `frame-background-mode'.

`MODE' should be set to either 'terminal, or 'light."
  `(let* ((colors (or (cdr (assoc ,mode color-theme-motion-colors))
          ...
          (aqua         (cdr (assoc 'blue colors)))
          (blue         (cdr (assoc 'blue colors)))
          (purple       (cdr (assoc 'purple colors)))
          (class '((class color) (min-colors 89)))
          (background-mode (if (eq ,mode 'day) 'light 'terminal)))
     ,@body))

(defmacro color-theme-motion--face-specs ()
  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (link (:foreground nil :underline nil))
      (widget-button (:underline nil))
      ...
      (grep-error-face (:foreground ,red :weight bold :underline nil))
      ...
      (info-xref-visited (:foreground ,comment :underline nil))
      ...
      (org-column-title (:inherit org-column :weight bold :underline nil))
      (org-date (:foreground ,blue :underline nil))
      ...
      (org-link (:foreground ,blue :underline nil))
      ...
      (speedbar-selected-face (:foreground ,red :underline nil))
      ...
      (vhdl-speedbar-architecture-selected-face (:foreground ,blue :underline nil))
      (vhdl-speedbar-configuration-face (:foreground ,green))
      (vhdl-speedbar-configuration-selected-face (:foreground ,green :underline nil))
      (vhdl-speedbar-entity-face (:foreground ,orange))
      (vhdl-speedbar-entity-selected-face (:foreground ,orange :underline nil))
      (vhdl-speedbar-instantiation-face (:foreground ,yellow))
      (vhdl-speedbar-instantiation-selected-face (:foreground ,yellow :underline nil))
      (vhdl-speedbar-library-face (:foreground ,purple))
      (vhdl-speedbar-package-face (:foreground ,aqua))
      (vhdl-speedbar-package-selected-face (:foreground ,aqua :underline nil))
      ...
      (bmkp-url (:foreground ,blue :underline nil))
      ...
      (dired-subtree-depth-1-face                               (:background nil :foreground ,purple))
      (dired-subtree-depth-2-face                               (:background nil :foreground ,blue))
      (dired-subtree-depth-3-face                               (:background nil :foreground ,red))
      (dired-subtree-depth-4-face                               (:background nil :foreground ,yellow))
      (dired-subtree-depth-5-face                               (:background nil :foreground ,purple))
      (dired-subtree-depth-6-face                               (:background nil :foreground ,blue))
      (dired-subtree-depth-7-face                               (:background nil :foreground ,red))
      (dired-subtree-depth-8-face                               (:background nil :foreground ,yellow))
      ;; e2wm
      ...
      ;; helm
      (helm-M-x-key (:foreground ,orange :underline nil))
      ...
      (helm-etags-file (:foreground ,yellow :underline nil))
      ...
      (helm-grep-file (:foreground ,purple :underline nil))
      ...
      (helm-moccur-buffer (:foreground ,aqua :underline nil))
      ...
      (markdown-link-face (:foreground ,blue :underline nil))
      ...
      (markup-title-0-face (:foreground ,blue :weight bold :underline nil))
      (markup-title-1-face (:foreground ,purple :weight bold :underline nil))
      (markup-title-2-face (:foreground ,orange :weight bold :underline nil))
      (markup-title-3-face (:foreground ,green :weight bold :underline nil))
      (markup-title-4-face (:foreground ,blue :weight bold :underline nil))
      (markup-title-5-face (:foreground ,purple :weight bold :underline nil))
      ...
      ;; swiper
      (swiper-line-face (:underline nil))
      ...
      ;; symbol-overlay
      (symbol-overlay-default-face (:inherit highlight :underline nil))
      ...
      (cscope-separator-face (:bold t :overline t :underline nil :foreground ,purple))
...
(defun color-theme-motion--theme-name (mode)
  (intern (format "motion-%s" (symbol-name mode))))

(defmacro color-theme-motion--define-theme (mode)
  "Define a theme for the tomorrow variant `MODE'."
  (let ((name (color-theme-motion--theme-name mode))
        (doc (format "A version of Chris Kempson's 'Tomorrow' theme (%s version)" mode)))
    `(progn
       (deftheme ,name ,doc)
       (put ',name 'theme-immediate t)
       (color-theme-motion--with-colors
        ',mode
        (apply 'custom-theme-set-faces ',name
               (color-theme-motion--face-specs))
  ...
  (if (fboundp 'load-theme)
    ...
    (progn
      ...
      (color-theme-motion--with-colors
       mode
       (color-theme-install
        `(,(intern (concat "color-theme-motion-" (symbol-name mode)))
          ,@(color-theme-motion--frame-parameter-specs)
          ,@(color-theme-motion--face-specs)))
...
;;;###autoload
(defun color-theme-motion-terminal ()
  "Apply the tomorrow terminal theme."
  (interactive)
  (color-theme-motion 'terminal))

;;;###autoload
(defun color-theme-motion-window ()
  "Apply the tomorrow window theme."
  (interactive)
  (color-theme-motion 'window))

(provide 'color-theme-motion)

;; Local Variables:
;; byte-compile-warnings: (not cl-functions)
;; End:

;;; color-theme-motion.el ends here
